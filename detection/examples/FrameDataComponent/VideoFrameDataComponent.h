...
#ifndef OPENMPF_CPP_COMPONENT_SDK_VIDEOFRAMEDATACOMPONENT_H
#define OPENMPF_CPP_COMPONENT_SDK_VIDEOFRAMEDATACOMPONENT_H


#include <adapters/MPFVideoFrameDataDetectionAdapter.h>
...
#endif //OPENMPF_CPP_COMPONENT_SDK_VIDEOFRAMEDATACOMPONENT_H
