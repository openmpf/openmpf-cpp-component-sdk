...
#ifndef OPENMPF_CPP_COMPONENT_SDK_MPFVIDEODETECTIONCOMPONENTADAPTER_H
#define OPENMPF_CPP_COMPONENT_SDK_MPFVIDEODETECTIONCOMPONENTADAPTER_H
...
namespace MPF { namespace COMPONENT {
    ...
    public:
        virtual ~MPFVideoDetectionComponentAdapter() = default;
...
#endif //OPENMPF_CPP_COMPONENT_SDK_MPFVIDEODETECTIONCOMPONENTADAPTER_H
